...
import com.padcmyanmar.thiha.moviebookingapp.persistence.TypeConverters.SnackPaymentTypeConverter
import com.padcmyanmar.thiha.moviebookingapp.persistence.TypeConverters.SnackTypeConverter
...
@TypeConverters(
    ...
    SnackTypeConverter::class
)
data class DataCarrierVO(
